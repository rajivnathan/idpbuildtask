...
cp -r /data/idp/src/target/liberty/wlp/usr/servers/defaultServer/* /data/idp/buildartifacts/
cp -r /data/idp/src/target/liberty/wlp/usr/shared/resources/ /data/idp/buildartifacts/
